"""samplerecord URL Configuration
...
from storesample.views import SampleListView

admin.autodiscover()
admin.site.site_header = "I16 Store Sample"
admin.site.site_title = "Admin your samples "
